<?php
class EmbajadorModel extends Query{
    private $Diplomatico, $Confirmacion, $Nacionalidad, $Recomendacion, $Fecha_emision, $estado;
    public function __construct()
    {
        parent::__construct();
    }

    public function getEmbaja ()
    {
        $sql = "SELECT * FROM embajador";
